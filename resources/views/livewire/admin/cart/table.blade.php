            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th width="140px" class="text-center" scope="col">نام هنرمند</th>
                        <th width="140px" class="text-center" scope="col">اسم اهنگ</th>
                    ...
                    @foreach($carts as $cart)
                        ...
                        <tr class="text-center">
                            <td>
                                {{$loop->iteration + $carts->firstItem() - 1}}
                            </td>
                            <td>
                                <div class="media">
                            ...
                            <td>
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <h6 class="mb-0">{{$cart->title}}</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <img src="{{ asset('/' . $cart->image) }}" width="90" alt="تصویر محصول">
                            </td>

                            <td class="text-center">
                                <div>
                                    <div class="form-check form-check-primary form-check-inline ms-3">
                                        <input wire:confirm="آیا مطمئن هستید؟" wire:change="changeStatus({{$cart->id}})"
                                               {{$cart->status?'checked': ''}}
                ...
                {{$carts->links('layouts.admin.pagination')}}
            </div>
        </div>
    </div>
</div>
